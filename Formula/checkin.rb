class Checkin < Formula
  ...
  url "https://github.com/bjcgg/checkin/releases/download/v0.2.0/checkin-darwin-arm64"
  version "0.2.0"
  license "MIT"
  ...
  on_macos do
    on_intel do
      url "https://github.com/bjcgg/checkin/releases/download/v0.2.0/checkin-darwin-x64"
  ...
  on_linux do
    if Hardware::CPU.intel?
      url "https://github.com/bjcgg/checkin/releases/download/v0.2.0/checkin-linux-x64"
